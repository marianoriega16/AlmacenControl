	  ...
	  <nav class="navbar navbar-default ">
	    <div class="container-fluid">
	      ...
	      <div class="navbar-header">
	        ...
	        <a class="navbar-brand" href="#">Control de Almacén</a>
	      </div>
	      ...
	      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <li class="<?php if (isset($active_pasillo)) { echo $active_pasillo; } ?>">
              <a href="pasillo.php"><i class='glyphicon glyphicon-menu-hamburger'></i> Pasillos</a>
            </li>
            <li class="<?php if (isset($active_estante)) { echo $active_estante; } ?>">
              <a href="estante.php"><i class='glyphicon glyphicon-inbox'></i> Estantes</a>
            </li>
