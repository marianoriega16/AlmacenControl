...
$active_clientes = "";
$active_usuarios = "";
$title = "Producto | Control de Almacén";
						...
						<div class="row">
							...
							<div class="col-sm-4 text-left">
								<div class="row margin-btm-20">
									<div class="col-sm-12">
										<span class="current-stock">NOMBRE:</span><br />
										<span class="item-title"> <?php echo $row['nombre_producto']; ?></span><br /><br />
									</div>

									<div class="col-sm-12 margin-btm-10">
										<span class="current-stock">CÓDIGO:</span><br />
										<span class="item-number"><?php echo $row['codigo_producto']; ?></span><br /><br />
									</div>

									<div class="col-sm-12 margin-btm-10">
										<span class="current-stock">STOCK DISPONIBLE:</span><br />
										<span class="item-number"><?php echo number_format($row['stock']) ?></span><br /><br />
									</div>

									<div class="col-sm-12 margin-btm-10">
										<span class="current-stock">CATEGORÍA ID:</span><br />
										<span class="item-number"><?php echo $row['id_categoria']; ?></span><br /><br />
									</div>

									<div class="col-sm-12 margin-btm-10">
										<span class="current-stock">PASILLO ID:</span><br />
										<span class="item-number"><?php echo $row['id_pasillo']; ?></span><br /><br />
									</div>

									<div class="col-sm-12 margin-btm-10">
										<span class="current-stock">ESTANTE ID:</span><br />
										<span class="item-number"><?php echo $row['id_estante']; ?></span><br /><br />
									</div>
...
<script>
	...
	$('#myModal2').on('show.bs.modal', function(event) {
		...
		modal.find('.modal-body #mod_pasillo').val(pasillo)
		modal.find('.modal-body #mod_estante').val(estante)
